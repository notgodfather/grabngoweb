  ...
  const login = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        const allowed =email.endsWith('@bmsce.ac.in') || email==='ankitranjan10may@gmail.com' || email==='shettyshreyas2604@gmail.com' || email==='vivekraaj87@gmail.com' || email.endsWith('@bmsce.org') || email.endsWith('@bmscl.ac.in') || email.endsWith('bmsca.ac.in');
        if (allowed) {
          setProfile(userData);
          setError('');
