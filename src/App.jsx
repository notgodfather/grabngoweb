  ...
  const login = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        const allowed =email.endsWith('@bmsce.ac.in') || email==='ankitranjan10may@gmail.com' || email==='shettyshreyas2604@gmail.com' || email==='vivekraaj87@gmail.com' || email.endsWith('@bmsce.org');
        if (allowed) {
          setProfile(userData);
          setError('');
